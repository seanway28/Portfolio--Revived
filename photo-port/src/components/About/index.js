...
const About = () => {
  ...
  <h3 className="title-text">Sean M. Conway</h3>
        ...
        Butler University Full Stack Code Development Executive Bootcamp recent  , mobile app development, cyber security and other new opportunities. I believe I can combine this new knowledge with by previous 10+ years as a Project Manager for several Caterpillar dealerships and corporate offices and my time at General Electric that gave me the inspiration to start my coding studies.
